...
with st.sidebar:
    ...
    **Exemples:**
    ...
    # Information sur la génération de PDF
    st.info("💡 **Génération de rapport PDF disponible**\n\nDemande simplement dans le chat : 'Génère un rapport PDF' pour obtenir une synthèse narrative professionnelle de notre conversation.")
